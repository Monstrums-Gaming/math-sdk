"""
Optimization setup for Candle Bet (2_10).

Candle Bet has FIXED, derived odds (a forced win/lose split), so there is nothing
...
class OptimizationSetup:
    ...
    def __init__(self, game_config: object):
        raise RuntimeError(
            "2_10 (Candle Bet) uses fixed, derived odds and is not optimised. "
