"""Driver script for Candle Bet (2_10).

Candle Bet is a Stake-style UP/DOWN binary game, not a reel game. The player
picks UP or DOWN; the round either wins (payout = the offered multiplier) or loses
