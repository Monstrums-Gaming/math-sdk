#!/usr/bin/env bash
# Serve the Candle Bet frontend demo locally over HTTP.
# The demo fetch()es candle_bet_rgs.json, so it must be served over http:// (file:// won't work).
# Usage:
