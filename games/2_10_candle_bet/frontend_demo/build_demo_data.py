#!/usr/bin/env python3
"""
Build the frontend-demo data bundle for Candle Bet (2_10) from the REAL generated
...
0). Emits ONE file the demo fetches:
    frontend_demo/candle_bet_rgs.json  { game_id, rtp, multiplier, winChance,
...
OUT_FILE = os.path.join(HERE, "candle_bet_rgs.json")
...
def main():
    ...
    game_id = cfg.get("gameID", "2_10_candle_bet")
