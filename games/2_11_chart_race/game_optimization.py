"""
Optimization setup for Chart Race (2_11).

Chart Race has FIXED, authored odds (a forced win/lose split per market), so there is
...
class OptimizationSetup:
    ...
    def __init__(self, game_config: object):
        raise RuntimeError(
            "2_11 (Chart Race) uses fixed, authored odds and is not optimised. "
