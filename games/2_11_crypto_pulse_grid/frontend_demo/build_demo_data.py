#!/usr/bin/env python3
"""
Build the frontend-demo data bundle for Crypto Pulse Grid (2_11) from the REAL
...
fetches:
    frontend_demo/crypto_pulse_grid_rgs.json
...
OUT_FILE = os.path.join(HERE, "crypto_pulse_grid_rgs.json")
...
def main():
    ...
    assert bundle["game_id"] == "2_11_crypto_pulse_grid", f"unexpected game_id {bundle['game_id']}"
    modes = bundle["modes"]
