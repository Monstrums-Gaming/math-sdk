#!/usr/bin/env bash
# Serve the Price Grid frontend demo locally over HTTP.
# The demo fetch()es price_grid_rgs.json, so it must be served over http:// (file:// won't work).
# Usage:
