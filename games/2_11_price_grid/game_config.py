"""
Price Grid (2_11) — game configuration.

A **tap-cell-to-bet** game: a denser-ladder variant of `2_10_crypto_pulse_grid`.
A live-looking price chart runs continuously; the future region of the chart is
covered by a grid of (time x price) multiplier cells. The player taps a cell to
place a chip; if the price line reaches that cell the chip pays
...
From the book's point of view this is exactly the `2_9_crypto_pulse` /
`2_10_crypto_pulse_grid` model: each chip is an independent **win/lose bet at a
fixed multiplier M** (the tapped cell is outcome-neutral). Like the dice (`2_4`),
limbo (`2_5`) and crypto-pulse (`2_9`/`2_10`) games this is a **direct-probability**
...
class GameConfig(Config):
    """Price Grid configuration — a 28-rung win/lose multiplier ladder."""
