"""
Optimization setup for Tap Trade (2_6).

Tap Trade has FIXED, derived odds (a forced win/lose split per ladder rung),
...
class OptimizationSetup:
    ...
    def __init__(self, game_config: object):
        raise RuntimeError(
            "2_6 (Tap Trade) uses fixed, authored odds and is not optimised. "
